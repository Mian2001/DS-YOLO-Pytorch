    ...
    if True:
        ...
        if Freeze_Train:
            for name, param in model.named_parameters():
                if "FR_module" in name:  # 如果是FR_module
                    param.requires_grad = True  # 则需要计算梯度
                else:  # 否则为yolo
                    param.requires_grad = False  # 则不需要计算梯度
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, yolo_loss, loss_ve, loss_history, eval_callback, optimizer, epoch,
                          epoch_step,
